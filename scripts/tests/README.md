# Tests — Открытость и достоверность Pipeline

Полный набор тестов для проверки корректности и воспроизводимости pipeline Никиты (nexus/MrBayes/уверенные клады).
...
| Восстановление топологии | Синтетические деревья | ⚠️ (норм. поведение) |
