...
Байесовские деревья по группам (задачи Никиты: **nexus** и **MRBayes** из
[../BioCad_repo.md](../BioCad_repo.md)). Обёртка над продакшн-движком
[`../biocode/trees/mrbayes.py`](../biocode/trees/mrbayes.py) (вендорено без
изменений из `BIOCAD.bigchallenges@main`), адаптированная под файловый вход/выход
