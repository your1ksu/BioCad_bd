"""
Тесты для scripts/01_filter_sequences/filter_sequences.py
...
SCRIPTS_DIR = os.path.join(
    ...
    "scripts", "01_filter_sequences")
sys.path.insert(0, SCRIPTS_DIR)

import filter_sequences as fs  # noqa: E402
...
#
# С тех пор как filter_sequences.py стал использовать paths.py (--key вместо
...
def test_main_end_to_end(tmp_path, monkeypatch):
    ...
    valid_seq = "A" * 150
    input_tsv = data_dir / "BCR_data.tsv"
